...
export const VALIDAR_CODIGO = 'VALIDAR_CODIGO';
...
export const OBTENER_SEGUIDORES_FECHA_ACTUAL = 'OBTENER_SEGUIDORES_FECHA_ACTUAL';
...
export const EDITAR_CAPITULO  = "EDITAR_CAPITULO";
export const OBTENER_GENEROS_SERIE = "OBTENER_GENEROS_SERIE";
export const OBTENER_VOTOS = "OBTENER_VOTOS";
export const OBTENER_SERIES_VERIFIED = "OBTENER_SERIES_VERIFIED";
...
export const OBTENER_REACCIONES_SERIE_USUARIO = "OBTENER_REACCIONES_SERIE_USUARIO";

//Administracion
export const OBTENER_IMAGENES_SLIDER = "OBTENER_IMAGENES_SLIDER";
export const SUBIR_IMAGEN_SLIDER = "SUBIR_IMAGEN_SLIDER";
export const BORRAR_IMAGEN_SLIDER = "BORRAR_IMAGEN_SLIDER";
export const OBTENER_NOTICIAS = "OBTENER_NOTICIAS";
export const SUBIR_NOTICIA = "SUBIR_NOTICIA";
export const ACTUALIZAR_NOTICIA = "ACTUALIZAR_NOTICIA";
export const BORRAR_NOTICIA = "BORRAR_NOTICIA";
export const VALIDAR_SERIE = "VALIDAR_SERIE";